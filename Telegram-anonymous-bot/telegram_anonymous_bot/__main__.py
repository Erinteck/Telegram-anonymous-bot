...
ADMINS = [7300000303]  # آیدی عددی ادمین‌ها این  آیدی پیش فرضه
...
async def start(event):
    user = await event.get_sender()
    channel_username = 'your channel id'  # ای دی کانال بدون @
...
SUPPORT_ADMIN_ID = 2010020079  # آی دی عددی پشتیبان این آی دی فرضیه
